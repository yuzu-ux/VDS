...
5. Self-check: readable at a glance (max ~5 lines of body text per slide); one accent; consistent margins; `data-vds-id` on every slide; counter shows correct total.
...
- `data-vds-id="slide-01"` (zero-padded) on every `<section class="slide">`.
